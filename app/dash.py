...
fig_contagem_resp = px.bar(contagem_resp,
                              ...
                              y = 'Responsabilidade',
                              text= 'Quantidade',
                              title = 'Número de Ocorrências por Responsabilidade',
                              color_discrete_sequence=['#1300A7'])
...
fig_contagem_causa = px.bar(contagem_causa.tail(10),
                              ...
                              y = 'Causa',
                              text= 'Quantidade',
                              title = 'Número de Ocorrências por Causa',
                              color_discrete_sequence=['#1300A7'])
...
fig_mediana_duracao_resp = px.bar(mediana_resp,
                              ...
                              y = 'Duracao',
                              text= 'Duracao',
                              title = 'Mediana da Duração(h) por Responsabilidade',
                              color_discrete_sequence=['#00BFF3'])
...
fig_mediana_consu_resp = px.bar(mediana_resp,
                              ...
                              title = 'Mediana de Consudimidores Atingidos por Responsabilidade',
                              color_discrete_sequence=['#156082'])
fig_mediana_consu_resp.update_layout(yaxis_title = 'Consudimidores Atingidos')
...
fig_mediana_chi_resp = px.bar(mediana_resp,
                              ...
                              y = 'CHI',
                              text= 'CHI',
                              title = 'Mediana de CHI por Responsabilidade',
                              color_discrete_sequence=['#08003B'])
...
fig_mediana_duracao_causa = px.bar(mediana_causa_duracao,
                              ...
                              y = 'Duracao',
                              text= 'Duracao',
                              title = 'Mediana da Duração(h) por Causa',
                              color_discrete_sequence=['#00BFF3'])
...
fig_mediana_consu_causa = px.bar(mediana_causa_cons,
                              ...
                              y = 'ConsumidoresAtingidos',
                              text= 'ConsumidoresAtingidos',
                              title = 'Mediana de Consudimidores Atingidos por Causa',
                              color_discrete_sequence=['#156082'])
...
fig_mediana_chi_causa = px.bar(mediana_causa_chi,
                              ...
                              y = 'CHI',
                              text= 'CHI',
                              title = 'Mediana de CHI por Causa',
                              color_discrete_sequence=['#08003B'])
